...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        SetEnvironmentVariable(name='GAZEBO_MODEL_PATH', value=os.path.join(get_package_share_directory('rover_description'), 'rover', 'meshes') + ':' + os.path.join(get_package_share_directory('rover_description'), 'urdf')),
