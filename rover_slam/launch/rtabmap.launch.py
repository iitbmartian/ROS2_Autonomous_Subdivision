...
def generate_launch_description():
    ...
    config_rviz = os.path.join(
        get_package_share_directory('rtabmap_launch'), 'launch', 'rviz', 'rgbd.rviz'
    )   
    config_rtabmap = os.path.join(
        get_package_share_directory('rover_slam'), 'config', 'rtabmap.yaml'
    )
    ...
    return LaunchDescription([
        ...
        # Config files
        DeclareLaunchArgument('cfg',      default_value=config_rtabmap,                        description='To change RTAB-Map\'s parameters, set the path of config file (*.ini) generated by the standalone app.'),
        ...
        DeclareLaunchArgument('frame_id',       default_value='root_link',          description='Fixed frame id of the robot (base frame), you may set "base_link" or "base_footprint" if they are published. For camera-only config, this could be "camera_link".'),
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/rgbd_camera/image',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/rgbd_camera/depth_image', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/rgbd_camera/camera_info',            description=''),
        ...
        DeclareLaunchArgument('rgbd_topic',       default_value='sync_image', description=''),
        ...
        DeclareLaunchArgument('scan_topic',           default_value='/lidar',       description=''),
        DeclareLaunchArgument('subscribe_scan_cloud', default_value='true',       description=''),
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/lidar/points', description=''),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='vo_odom',  description='Odometry topic name.'),
